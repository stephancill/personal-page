...
export const Header = () => {
  return <div>
      ...
      <div style={{marginLeft: "10px"}}>
        ...
        <div style={{marginTop: "6px"}}>
          <a href="https://twitter.com/stephancill" target="_blank" rel="noopener noreferrer">
            <span style={{marginRight: "5px"}}><TwitterIcon /></span>  
          </a>
    ...
    <div style={{marginTop: "20px"}}>Builder, thinker, tech optimist. Interested in <i>decentralized technology</i> and <i>personal crypto hardware</i>.</div>
  </div> 
}